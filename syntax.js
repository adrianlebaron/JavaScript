...
// Anything you put inside of it is not going to run. Before I show you the syntax for this I want to make one statement about code comments and this is something that I've seen through the years. And so I want to introduce it now. And that is that you need to be very intentional about your code comments. Because I have seen many developers especially new developers that load up their programs with all kinds of comments and what I've seen.
//  also happen is as that program develops and as they change functionality in their programs they don't always go back and update the comment.
...
//  they're not going to fit the updated version of the code.
...
//  That's a little kind of a best practice when we're talking about how we organize code and how we name things that may not seem like a big deal.
//  But the more advanced a project gets the more important naming gets. And you don't want to rely on comments because those could say anything and they can be very confusing and lead to some bugs if they're not updated.

// With all that being said now let me show you actually how to use comments. There's two different ways you can do it, the first way is a single line comment. With that you just do two slashes // and then you can put anything you want after that for example.
