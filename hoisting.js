// Guide to JavaScript Hoisting video
...
// We've talked about variable's. How to define them, how into reassign values, we've talked about the differences between the let and var and now we're going to talk about something that is pretty much specific to javascript.
...
// It looks for all of these kind of things like var name; and it actually pre loads this at the very top. Writing this code is really viewed more like this,
...
// console.log(age);
// var age = 15
// Now if I come here and run this. You can see it doesn't print out 15. It prints out undefined. If you've never worked with hoisting before, javascript, that may seem a little bit weird because it kind of looks like we declared the age variable but actually we declared it and assigned it to a value at the same time. When ever you do that that is viewed differently by the javascript interpreter compared with if you just defined it. 
