...
str.concat(' again and again'); // "The quick brown fox jumped over the lazy dog again and again" TEMPORARY

var newStr = str.concat(' again and again');

newStr; // "The quick brown fox jumped over the lazy dog again and again"
...
// part 2 Working with String Functions - Part 2
...
// PART 3 Working with String Functions - Part 3
...
str.slice(4, 10).trim(); // "quick" cleans up the white space
